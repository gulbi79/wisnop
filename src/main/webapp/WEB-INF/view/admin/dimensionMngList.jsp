...
<%@ include file="/WEB-INF/view/layout/include.jsp" %>
    ...
    function fn_setColumns(grd) {
        ...
        var columns = [
            ...
            },
            {
                ...
                header: {text: '<spring:message code="lbl.align"/>'},
	...
	function fn_getExcelData(){
		...
		EXCEL_SEARCH_DATA = "";
		EXCEL_SEARCH_DATA += '<spring:message code="lbl.dimension"/> : ';
		EXCEL_SEARCH_DATA += $("#SEARCH_DIM_CD").val();
		
		EXCEL_SEARCH_DATA += '\n<spring:message code="lbl.dimensionName"/> : ';
		EXCEL_SEARCH_DATA += $("#SEARCH_DIM_NM").val();
...
<body id="framesb">
	...
	<div id="grid1" class="fconbox">
		...
		<div class="srhwrap">
			...
			<ul>
				<li>
				<strong><spring:message code="lbl.dimension"/></strong>
				<div class="selectBox">
				<input type="text"  id="SEARCH_DIM_CD" name="SEARCH_DIM_CD" class="ipt">
				</div>
				</li>
				<li>
				<strong><spring:message code="lbl.dimensionName"/></strong>
				<div class="selectBox">
