		...
		*/
		bscGrid : {
			...
			setColumn     : function () {
				...
				[
					{
						name : "DATA01", fieldName: "DATA01", editable: false, header: {text: '제품'},
						styles: {textAlignment: "center", background : gv_noneEditColor},
						dynamicStyles : [gfn_getDynamicStyle(0)],
						mergeRule    : { criteria: "value" },
						width: 80
					}, {
						name : "DATA02", fieldName: "DATA02", editable: false, header: {text: '2018/09'},
						styles: {textAlignment: "center", background : gv_noneEditColor},
						dynamicStyles : [gfn_getDynamicStyle(0)],
						mergeRule    : { criteria: "value" },
						width: 80
					}, {
						name : "DATA03", fieldName: "DATA03", editable: false, header: {text: '2018/10'},
						styles: {textAlignment: "center", background : gv_noneEditColor},
						dynamicStyles : [gfn_getDynamicStyle(0)],
						mergeRule    : { criteria: "value" },
						width: 80
					}, {
						name : "DATA04", fieldName: "DATA04", editable: false, header: {text: '2018/11'},
						styles: {textAlignment: "center", background : gv_noneEditColor},
						dynamicStyles : [gfn_getDynamicStyle(0)],
						mergeRule    : { criteria: "value" },
						width: 80
					}, {
						name : "DATA05", fieldName: "DATA05", editable: false, header: {text: '2018/12'},
						styles: {textAlignment: "center", background : gv_noneEditColor},
						dynamicStyles : [gfn_getDynamicStyle(0)],
						mergeRule    : { criteria: "value" },
						width: 80
					}, {
						name : "DATA06", fieldName: "DATA06", editable: false, header: {text: '2019/01'},
						styles: {textAlignment: "center", background : gv_noneEditColor},
						dynamicStyles : [gfn_getDynamicStyle(0)],
						mergeRule    : { criteria: "value" },
						width: 80
					}, {
						name : "DATA07", fieldName: "DATA07", editable: false, header: {text: '...'},
						styles: {textAlignment: "center", background : gv_noneEditColor},
						dynamicStyles : [gfn_getDynamicStyle(0)],
						width: 80
					}, {
						name : "DATA08", fieldName: "DATA08", editable: false, header: {text: '2019/08'},
						styles: {textAlignment: "center", background : gv_noneEditColor},
						dynamicStyles : [gfn_getDynamicStyle(0)],
						width: 80
					}, 
