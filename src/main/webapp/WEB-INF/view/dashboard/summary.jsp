...
<jsp:include page="/WEB-INF/view/layout/include.jsp" flush="false">
    ...
    function fn_initEvent() {
    	...
    	$.each(arrTitle, function(n,v) {
    		...
    		$(v).on("click", function() { 
    			if (n == 0) gfn_newTab("BSC101"); // BSC 종합
    			else if (n == 1) gfn_newTab("SNOP201"); // 경영실적
    			else if (n == 2) gfn_newTab("SNOP205"); // 제품 재고 현황
    			else if (n == 3) gfn_newTab("QT101");  // 불량률 
    			else if (n == 4) gfn_newTab("DP208");  // 출하예상 
    			else if (n == 5) gfn_newTab("SNOP205");// 자재 재고
    			else if (n == 6) gfn_newTab("MP104");  // 주간 생산 계획 준수율 
    			else if (n == 7) gfn_newTab("MP104");  // 주간 출하 계획 준수율
    			else if (n == 8) gfn_newTab("SNOP305");// 주간 자재 가용률
    		});
    	});
    }
