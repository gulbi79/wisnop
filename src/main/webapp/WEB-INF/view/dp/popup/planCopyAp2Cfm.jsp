	...
	gfn_service({
	    ...
	    success :function(data) {
	    	...
	    	$.each(data.meaList, function(n, v) {
				...
				if(cd == "AP2_DMD1_SP_W1" || cd == "AP2_DMD2_SP_W1" || cd == "AP2_DMD3_SP_W1" || cd == "AP2_SP_W1" ||
	    		   cd == "AP2_DMD1_SP" || cd == "AP2_DMD2_SP" || cd == "AP2_DMD3_SP" || cd == "AP2_SP" ||
	    		   cd == "CFM_DMD1_SP" || cd == "CFM_DMD2_SP" || cd == "CFM_DMD3_SP" || cd == "CFM_SP"){	    			
...
function fn_initFilter() {
	...
	if(measureCd == "AP2_SP"){
		...
		targetExcept = ["AP2_DMD1_SP_W1", "AP2_DMD2_SP_W1", "AP2_DMD3_SP_W1", "AP2_SP_W1"];	
	...
	if(measureCd == "AP2_SP"){
		...
		$.each(codeMap.MEASURE, function(i, val){
			...
			if(codeCd == "AP2_DMD1_SP_W1" || codeCd == "AP2_DMD2_SP_W1" || codeCd == "AP2_DMD3_SP_W1" || codeCd == "AP2_SP_W1"){
				cnt++;
			}
		});
		
		if(cnt < 4){
			sourceExcept.push("AP2_SP_W1");
	...
	//}else if(measureCd == "CFM_SP" && typeCd != "Value"){
		...
		$.each(codeMap.MEASURE, function(i, val){
			...
			if(codeCd == "AP2_DMD1_SP" || codeCd == "AP2_DMD2_SP" || codeCd == "AP2_DMD3_SP" || codeCd == "AP2_SP"){
				cnt++;
			}
		});
