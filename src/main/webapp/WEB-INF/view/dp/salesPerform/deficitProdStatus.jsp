...
<%@ include file="/WEB-INF/view/layout/include.jsp" %>
	...
	var deficitProdPresent = {
		...
		_siq    : "dp.salesPerform.deficitProdPresentList",
	...
	function fn_authority(gridData) {
		...
		gfn_service({
		    ...
		    data    : {
		    			_mtd : "getList",
		    			tranData : [
		    				{outDs : "authorityList", _siq : "dp.salesPerform.authority"}
		    			]
		    },
		    success :function(data) {
	...
	function fn_setNextFieldsBuket() {
		var fields = [
			{fieldName: "OPEN_YN", dataType : "text"},
