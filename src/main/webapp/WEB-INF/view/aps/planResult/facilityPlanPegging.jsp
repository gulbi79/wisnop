			...
			var aOption = {
				...
				success : function (data) {
					...
					if (FORM_SEARCH.sql == 'N') {
						...
						facilityPlanPegging.facilityPlanPeggingGrid.dataProvider.clearRows(); //데이터 초기화
						...
						facilityPlanPegging.facilityPlanPeggingGrid.dataProvider.savePoint(); //초기화 포인트 저장
