...
<script type="text/javascript">
    ...
    var procurType = "${param.procurType}";
    var itemGroup = "${param.itemGroup}";
    var itemType = "${param.itemType}";
    var mrpQtyTot = "${param.mrpQtyTot}";
    var molQtyTot = "${param.molQtyTot}";
    var item_cd   = "${param.item_cd}";
    var parentItem_cd = "${param.parentItem_cd}";
    ...
    var matRequirPlanDetail = {
        ...
        _siq    : "aps.planResult.matRequirPlanDetailItemAll",
            ...
            initCode  : function() {
                ...
                gfn_service({
                    ...
                    data    : {
                        ...
                        buCd        : gBuCd,
                        planId      : gPlanId,
                        tranData : [{outDs : "versionIdList", _siq : "aps.planResult.matRequirPlanDetailVersionId"}]
                    },
    ...
    var fn_apply = function (sqlFlag) {
        ...
        FORM_SEARCH.procurType = procurType;
        FORM_SEARCH.itemGroup  = itemGroup;
        FORM_SEARCH.itemType   = itemType;
        FORM_SEARCH.mrpQtyTot  = mrpQtyTot;
        FORM_SEARCH.molQtyTot  = molQtyTot;
        FORM_SEARCH.item_cd    = item_cd;
        FORM_SEARCH.parentItem_cd = parentItem_cd;
    ...
    function fn_excelSqlAuth() {
        ...
        gfn_service({
            ...
            data    : {
                ...
                tranData : [
                    {outDs : "authorityList", _siq : "aps.planResult.matRequirPlanDetailExcelSql"}
                ]
            },
            success :function(data) {
...
<body>
    ...
    <div id="keywordpop" class="popupDv">
        <div class="pop_tit"><spring:message code="lbl.matReqPlanDetailList"/></div>
        <div class="popCont">
            <div class="srhwrap">
