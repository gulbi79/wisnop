...
<%@ include file="/WEB-INF/view/layout/include.jsp" %>
		...
		*/
		bizPlanHrGrid : {
			...
			initGrid     : function () {
				...
				gfn_setMonthSum(bizPlanHr.bizPlanHrGrid.gridInstance, false, false, true);
			}
		},
		...
		*/
			...
			var aOption = {
				...
				success : function (data) {
					...
					if (FORM_SEARCH.sql == 'N') {
						bizPlanHr.bizPlanHrGrid.dataProvider.clearRows(); //데이터 초기화
				
						//그리드 데이터 생성
						bizPlanHr.bizPlanHrGrid.grdMain.cancel();
						
						bizPlanHr.bizPlanHrGrid.dataProvider.setRows(data.resList);
						bizPlanHr.bizPlanHrGrid.dataProvider.clearSavePoints();
						bizPlanHr.bizPlanHrGrid.dataProvider.savePoint(); //초기화 포인트 저장
						gfn_actionMonthSum(bizPlanHr.bizPlanHrGrid.gridInstance);
						gfn_setRowTotalFixed(bizPlanHr.bizPlanHrGrid.grdMain);
					}
				}
			}
		...
		getBucket : function (sqlFlag) {
			...
			if(!sqlFlag){
				...
				bizPlanHr.bizPlanHrGrid.gridInstance.setDraw();
				
				var fileds = bizPlanHr.bizPlanHrGrid.dataProvider.getFields();
				...
				bizPlanHr.bizPlanHrGrid.dataProvider.setFields(fileds);
			} 
		}
	};
	...
	var fn_apply = function (sqlFlag) {
		...
		bizPlanHr.getBucket(sqlFlag); //2. 버켓정보 조회
...
<body id="framesb">
	...
	<div id="a" class="split content split-horizontal">
		...
		<input type="hidden" id="pageFlag" name="pageFlag" value="M0"> 
