	...
	var inventorySynthesis = {
		...
		initFilter : function() {
			...
			gfn_setMsComboAll([
				...
				{target : 'divComOut', id : 'comOut', title : '<spring:message code="lbl.storage"/>', data : this.comCode.codeMap.COM_OUT_CD, exData:[""], option: {allFlag:"Y"}},
				...
				{target : 'divSlCd', id : 'slCd', title : '<spring:message code="lbl.storage2"/>', data : this.comCode.codeMapEx.SL_CD, exData:[""], option: {allFlag:"Y"}},
			]);
	...
	function fn_setBeforeColumnsBuket() {
        ...
        var columns = [
        	{ 
				type      : "group",
				name      : "BEF_LAST_YEAR", 
				header    : { fixedHeight : 20, text : "<spring:message code='lbl.year'/>" },
				width     : 330, 
				columns   : [
					{
						name      : "BEF_LAST_GR_AVG_QTY", 
						fieldName : "BEF_LAST_GR_AVG_QTY", 
						header    : { text : "<spring:message code='lbl.monthAvgWare'/>" }, 
						...
						header    : { text : "<spring:message code='lbl.monthAvgRele'/>" }, 
						...
						header    : { text : "<spring:message code='lbl.yearInv'/>" }, 
						styles    : { textAlignment : "far", background : gv_noneEditColor, numberFormat : "#,##0"},
						dynamicStyles:[gfn_getDynamicStyle(-2)],
						width     : 110, 
						editable  : false 
