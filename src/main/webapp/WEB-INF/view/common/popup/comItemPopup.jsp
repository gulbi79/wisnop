...
function fn_setColumns(grid) {
    var columns = [
		{name: "ITEM_CD"		,fieldName: "ITEM_CD"		,header: {text: '<spring:message code="lbl.item"/>'			} ,styles: {textAlignment: "near"  } ,width: 80 },
		{name: "ITEM_NM"		,fieldName: "ITEM_NM"		,header: {text: '<spring:message code="lbl.itemName"/>'		} ,styles: {textAlignment: "near"  } ,width: 120 },
		{name: "SPEC"			,fieldName: "SPEC"			,header: {text: '<spring:message code="lbl.spec"/>'			} ,styles: {textAlignment: "near"  } ,width: 120 },
		{name: "ITEM_TYPE_NM"	,fieldName: "ITEM_TYPE_NM"	,header: {text: '<spring:message code="lbl.itemType"/>'		} ,styles: {textAlignment: "near"  } ,width: 50  },
		{name: "DRAW_NO"		,fieldName: "DRAW_NO"		,header: {text: '<spring:message code="lbl.drawNo"/>'		} ,styles: {textAlignment: "near"  } ,width: 120 },
		{name: "ITEM_GROUP_NM"	,fieldName: "ITEM_GROUP_NM"	,header: {text: '<spring:message code="lbl.itemGroupName"/>'} ,styles: {textAlignment: "near"  } ,width: 120 },
		{name: "CUST_GROUP_NM"	,fieldName: "CUST_GROUP_NM"	,header: {text: '<spring:message code="lbl.custGroupName"/>'} ,styles: {textAlignment: "near"  } ,width: 100 },
    ];
		...
		<div class="popCont">
			<div class="srhwrap">
				...
				<ul>
					...
					<div class="selectBox">
					<input type="text" id="ITEM_NM" name="ITEM_NM" value="${param.ITEM_NM}" class="ipt" style="width:${lvWidth};">
					</div>
					</li>
					<li>
