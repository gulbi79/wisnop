...
<script type="text/javascript">
	...
	var longRiverOrderTopItem = {
		...
		_siq    : "supply.purchase.detailInfoList",
		...
		getBucket : function(sqlFlag) {
			...
			if (!sqlFlag) {
				longRiverOrderTopItem.grid.gridInstance.setDraw();
			...
			var aOption = {
				...
				success : function (data) {
					...
					if (FORM_SEARCH.sql == 'N') {
						...
						//gfn_actionMonthSum(longRiverOrderTopItem.grid.gridInstance);
	...
	var fn_apply = function(sqlFlag) {
		...
		longRiverOrderTopItem.getBucket(sqlFlag);
	}
