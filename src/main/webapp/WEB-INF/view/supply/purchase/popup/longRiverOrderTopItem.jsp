...
<script type="text/javascript">
	...
	var longRiverOrderTopItem = {
		...
		_siq    : "supply.purchase.topIetmList",
		...
		baseData : function(){
			...
			FORM_SEARCH.tranData = [{ outDs : "yearList",_siq : this._siq + "Year"}];
			...
			var aOption = {
				...
				success : function (data) {
					...
					longRiverOrderTopItem.grid.grdMain.setColumnProperty("PARENT_LAST_YEAR_QTY", "header", lastYear);	
					longRiverOrderTopItem.grid.grdMain.setColumnProperty("CHILD_LAST_YEAR_QTY", "header", lastYear);	
					
					longRiverOrderTopItem.grid.grdMain.setColumnProperty("PARENT_CUR_YEAR_QTY", "header", curYear);	
					longRiverOrderTopItem.grid.grdMain.setColumnProperty("CHILD_CUR_YEAR_QTY", "header", curYear);
			...
			var aOption = {
				...
				success : function (data) {
					...
					if (FORM_SEARCH.sql == 'N') {
						longRiverOrderTopItem.grid.dataProvider.clearRows(); //데이터 초기화
				
						//그리드 데이터 생성
						longRiverOrderTopItem.grid.grdMain.cancel();
						
						longRiverOrderTopItem.grid.dataProvider.setRows(data.resList);
						//longRiverOrderTopItem.grid.dataProvider.clearSavePoints();
						//longRiverOrderTopItem.grid.dataProvider.savePoint(); //초기화 포인트 저장
						//gfn_setSearchRow(longRiverOrderTopItem.grid.dataProvider.getRowCount());
						//gfn_actionMonthSum(commFacility.grid.gridInstance);
						//gfn_setRowTotalFixed(longRiverOrderTopItem.grid.grdMain);
					}
				}
			}
	...
	var fn_apply = function (sqlFlag) {
    	...
    	longRiverOrderTopItem.search();
	}
	
	// onload 
	$(document).ready(function() {
		longRiverOrderTopItem.init();
		fn_excelSqlAuth();
	...
	<div id="keywordpop" class="popupDv">
		...
		<div class="popCont">
			<div class="srhwrap">
				...
				<ul>
					<li>
						<strong class="srhcondipop"><spring:message code="lbl.materialsUseYn"/></strong>
						<div class="selectBox">
